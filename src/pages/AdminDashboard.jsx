...
export default function AdminDashboard() {
      ...
      await Promise.all(
        contests.map(async (contest) => {
          ...
          try {
            ...
            console.log("📦 PARTICIPANTS RESPONSE:", id, pData);
            ...
            console.log("🚀 PROJECT API RESPONSE:", id, projData);

            projectsMap[id] = projData?.mag || [];
          } catch (err) {
            console.error(`❌ FETCH ERROR (contest ${id}):`, err);
  ...
  const totalSoloOrParticipants = Object.values(participantsData || {}).flat()
    .length;
  ...
  return (
    <AdminDashboardUI
      ...
      metrics={{
        ...
        totalTeams,
        totalParticipants: totalSoloOrParticipants,
        totalSubmissions,
      }}
    />
  );
